 ...
 */
function geojsonType$2(value, type, name) {
 ...
 */
function featureOf$2(feature, type, name) {
 ...
 * @throws {Error} if value is not the expected type.
 */
function collectionOf$2(featureCollection, type, name) {
 ...
 * //="Point"
 */
function getType$2(geojson, name) {
...
var invariant = Object.freeze({
	getCoord: getCoord$2,
	getCoords: getCoords$2,
	containsNumber: containsNumber$2,
	geojsonType: geojsonType$2,
	featureOf: featureOf$2,
	collectionOf: collectionOf$2,
	getGeom: getGeom$2,
	getGeomType: getGeomType$2,
	getType: getType$2
});
...
L.TrueSize = L.Layer.extend({
  ...
  _createMarker: function _createMarker(center, options) {
    ...
    return L.marker(center, { icon: dragIcon, draggable: true }).on('dragstart', this._onMarkerDragStart, this).on('drag', this._onMarkerDrag, this);
  },
